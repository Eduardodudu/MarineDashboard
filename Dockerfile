...
RUN Rscript -e 'remotes::install_version("waiter",upgrade="never", version = "0.2.2")'
RUN Rscript -e 'remotes::install_version("tidyr",upgrade="never", version = "1.1.3")'
RUN Rscript -e 'remotes::install_version("shiny.semantic",upgrade="never", version = "0.4.2")'
RUN Rscript -e 'remotes::install_version("readr",upgrade="never", version = "1.4.0")'
RUN Rscript -e 'remotes::install_version("purrrlyr",upgrade="never", version = "0.0.7")'
...
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');MarineDashboard::run_app()"
